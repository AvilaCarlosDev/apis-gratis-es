...
Busca cualquier lugar del mundo (un barrio, una plaza, una ciudad, una dirección) y obtén hasta cinco coincidencias con su dirección, sus coordenadas y un enlace para verlo en el mapa. También estima tu ubicación aproximada, con país, ciudad, zona horaria y prefijo telefónico. Es una demo de cómo usar dos APIs gratuitas del [catálogo](../../README.md) sin backend ni claves.
...
- `index.html` declara una política de seguridad de contenido: scripts solo propios, conexiones solo a `photon.komoot.io` e `ipwho.is`, sin imágenes externas.
...
- Ubicación aproximada de [ipwho.is](https://ipwho.is/). Su endpoint gratuito admite 1.000 peticiones al día por IP de cliente y permite uso comercial; los datos de Photon exigen atribuir a OpenStreetMap y su uso debe ser justo, porque el uso intensivo se limita.
