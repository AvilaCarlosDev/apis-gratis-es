...
- [Feriados](demos/feriados/README.md): los feriados de cada año en 20 países, con el próximo y los días que faltan.
- [Ubicación](demos/ubicacion/README.md): busca cualquier lugar del mundo y obtén sus coordenadas, o estima tu ubicación aproximada.
...
| [Photon (Komoot)](https://photon.komoot.io/) | Búsqueda de lugares y geocodificación con datos de OpenStreetMap, con respuesta en GeoJSON. (Global) | No especificado | Obligatoria (ODbL (datos de OpenStreetMap)) | Uso justo: el uso intensivo se limita. Los datos son de OpenStreetMap: hay que atribuir «© colaboradores de OpenStreetMap» (ODbL). Servicio de terceros sin garantía de disponibilidad; el proyecto es de código abierto (Apache-2.0) y se puede alojar por cuenta propia. | Abierto | ✅ 2026-09-19 · 768 ms |
| [ipwho.is — geolocalización por IP](https://ipwho.is/) | País, ciudad, zona horaria y otros datos aproximados a partir de una dirección IP. (Global) | Sí | No especificada | El endpoint gratuito admite 1.000 peticiones al día por IP de cliente. | Abierto | ✅ 2026-09-19 · 180 ms |
...
- **Datos y diseño de las demos.** Cada demo cita a sus fuentes en su propia página y en su README: el clima es de [Open-Meteo](https://open-meteo.com/) (CC BY 4.0, uso no comercial); los feriados, de [Nager.Date](https://github.com/nager/Nager.Date) (MIT); los lugares, de [Photon](https://github.com/komoot/photon) (Apache-2.0) con datos de © colaboradores de [OpenStreetMap](https://www.openstreetmap.org/copyright) (ODbL); la ubicación aproximada, de [ipwho.is](https://ipwho.is/); la tasa del dólar, de [DolarAPI](https://github.com/enzonotario/dolarapi.com) (MIT); y los productos de ejemplo, de [FakeStoreAPI](https://github.com/keikaavousi/fake-store-api) y [DummyJSON](https://github.com/Ovi/DummyJSON), con sus fotos y nombres, que son datos de demostración y pertenecen a sus dueños. La tipografía es Bricolage Grotesque (SIL OFL 1.1), con su licencia en [`demos/compartido/fuentes/OFL.txt`](demos/compartido/fuentes/OFL.txt). Los íconos son dibujos propios. El aspecto de las páginas se inspira en ideas generales de diseño de directorios de APIs, apps de clima y tiendas en línea; no se copió código, imágenes, logotipos ni textos de ningún sitio, y las marcas mencionadas pertenecen a sus dueños.
